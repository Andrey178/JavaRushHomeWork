package com.javarush.testweb.lv16.ls03.ts05;
...
public class Solution {
    ...
    public static class Violin implements MusicalInstrument {
        ...
        public void run()
        {
            ...
            int songlenth = (int) (stopplay.getTime() - startplay.getTime());
            System.out.println(String.format("Playing %d ms", songlenth));
        }
    }
