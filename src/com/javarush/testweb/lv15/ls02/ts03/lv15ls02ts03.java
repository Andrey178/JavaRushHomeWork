package com.javarush.testweb.lv15.ls02.ts03;

/**
 * Created by Admin on 15.04.2016.
 */
public class lv15ls02ts03
/* ООП - машинки
...

{
    public static void main(String[] args) {
        new lv15ls02ts03.LuxuriousCar().printlnDesire();
        new lv15ls02ts03.CheapCar().printlnDesire();
        new lv15ls02ts03.Ferrari().printlnDesire();
        new lv15ls02ts03.Lanos().printlnDesire();
// В строках выше замена на имя актального класса   new Solution.Lanos().printlnDesire();
    }
