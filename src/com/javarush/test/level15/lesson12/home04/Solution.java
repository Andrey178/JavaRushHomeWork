...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() {
        ...
        try
        {
            ...
            if (Planet.SUN.equals(newplanet)) thePlanet = Sun.getInstance();
            else if (Planet.EARTH.equals(newplanet)) thePlanet = Earth.getInstance();
            else if (Planet.MOON.equals(newplanet)) thePlanet = Moon.getInstance();
