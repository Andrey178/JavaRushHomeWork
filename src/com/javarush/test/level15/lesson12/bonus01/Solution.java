...
public class Solution {
    ...
    public static void reset()
    {
        ...
        String getplanename = null;
        try
        {
            getplanename = reader.readLine();

            if ("plane".equals(getplanename)) {
                int maxpas = Integer.parseInt(reader.readLine());
                result = new Plane(maxpas);
            } else if ("helicopter".equals(getplanename)) {
